...
export const OverlayInfo = ({areaId, touchUpEvent, touchDownEvent, setTouchUpEvent, setTouchDownEvent}: OverlayInfoProps)=>{
    ...
    return(
    <div 
        className={`${styles.overlayAreaInfoView} ${touchDownEvent ? styles.touchDown:""} ${touchUpEvent ? styles.touchUp:""}`} 
