...
const ModifyPhonenumber = ()=>{
    ...
    <div className={styles.container}>
        ...
        <div className={styles.inputBox}>
            <div>
                <input value ={phonenumber} onChange={(e)=>setPhonenumber(e.target.value)} className={styles.input} style={{width:'59vw'}}  inputMode="numeric" type="text" placeholder="변경할 전화번호를 입력하세요."/>
