...
const ModifyPhonenumber = ()=>{
    ...
    <div className={styles.container}>
        ...
        <div className={styles.inputBox}>
            <div>
                <input className={styles.input} style={{width:'59vw'}}type="text" placeholder="변경할 전화번호를 입력하세요."/>
                <button style={{width:'28.5vw',height:'5.5vh'}}onClick={()=>setOpen(true)}>인증 요청</button>
            </div>
            {open&&<input className={styles.input} type="text" placeholder="인증번호를 입력하세요"/>}
        </div>
